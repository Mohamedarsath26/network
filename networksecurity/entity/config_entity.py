...
class DataIngestionConfig:
    def __init__(self,training_pipeline_config:TrainingPipelinConfig):
...
class DataValidationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelinConfig):
        ...
        self.drif_report_file_path:str = os.path.join(
...
class ModelTrainerConfig:
    def __init__(self,traineing_pipeline_config:TrainingPipelinConfig):
        self.model_trainer_dir:str = os.path.join(traineing_pipeline_config.artifact_dir,training_pipeline.MODEL_TRAINER_DIR_NAME)
